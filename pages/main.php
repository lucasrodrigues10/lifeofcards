        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-auto">
                <div class="form-group">
                    <p style="font-size:1rem;color:black;font-family:'Francois One', sans-serif;text-align: center; ">
                        Seu ID: <?php echo $id ?> </p>
                    ...
                    <div class="txt-perfil">
                        ...
                        <div class="progress" style="width: 95%;margin:1.2em auto">
                            ...
                            <div class="progress-bar" role="progressbar"
                                 style="width: <?php if (isset($exp)) echo($exp); ?>%"
                                 aria-valuenow="<?php if (isset($exp)) echo($exp); ?>"
