...
<style>document.body.addEventListener('touchmove', function(e){ e.preventDefault(); });</style>

    <!--JQuery, Javascript para Bootstrap, Phaser -->
	...
	<script type="text/javascript" src="jogo.js">
